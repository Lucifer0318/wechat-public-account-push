export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxb8a72d8e444f64d2",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "edb8d14923aef77e461f5343fd81862d",
  ...
  USERS: [
    {
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "l8QvCEunS7juoz2oy6CsCnNkQ0hq4CDYa7-NKS5qYz8",
      // 所在省份
      province: "重庆",
      // 所在城市
      city: "重庆",
      ...
      openUrl: "https://user.qzone.qq.com/1768674705/main",
